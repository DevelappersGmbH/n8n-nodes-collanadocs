...
export const documentFields: INodeProperties[] = [
	...
	},
	{
		...
		typeOptions: { rows: 12 },
		default: '',
		hint: 'Keep this on Fixed: in Expression mode n8n evaluates the {{ }} tags in the template',
	...
	},
	{
		...
		required: true,
		displayOptions: pdfOnly,
		placeholder: '{ "schema_version": 1, "common": { ... }, "offer": { ... } }',
		hint: 'Required for PDF output. Pick the language in the workflow and pass that one document.',
		description:
			'The localization document as JSON, reachable in the templates as t.*. The service rejects PDF requests that carry none.',
	},
	{
		displayName: 'Margins',
		name: 'margins',
